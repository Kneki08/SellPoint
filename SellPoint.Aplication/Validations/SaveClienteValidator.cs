...
{
    public class SaveClienteValidator: ValidatorBase<SaveClienteDTO>
    {
        public override bool Validate(SaveClienteDTO dto, out List<string> errors)
        {
            ...
            else if (dto.PasswordHash.Length < 8)
